...
public class ProjectsTest extends BaseTest {
    ...
    @Test(priority = 1,dataProvider = "data_Info_Project", dataProviderClass = DataProviderFactory.class)
    ...
    @Test(priority = 2,dependsOnMethods = "testAddNewProject",dataProvider = "data_Info_Project", dataProviderClass = DataProviderFactory.class)
    ...
    @Test(priority = 3,dependsOnMethods = "testEditProject",dataProvider = "data_Info_Project", dataProviderClass = DataProviderFactory.class)
    ...
    @Test(priority = 5,dataProvider = "data_Info_Project", dataProviderClass = DataProviderFactory.class)
    ...
    @Test(priority = 6,dataProvider = "data_Info_EditProjectStatus",  dataProviderClass = DataProviderFactory.class)
    ...
    @Test(priority = 7,dataProvider = "data_AttachFile", dataProviderClass = DataProviderFactory.class)
    ...
    @Test(priority = 7,dataProvider = "data_AttachFile", dataProviderClass = DataProviderFactory.class)
    public void testDeleteAttachFile(Hashtable<String, String> dataAttachFile){
        loginPage.loginHRM(ConfigData.EMAIL,ConfigData.PASSWORD)
                .verifyLoginSuccess()
                .clickMenuProject()
