...
public class ClientsTest extends BaseTest {
    ...
    @Test(priority = 1 ,dataProvider = "data_Info_Clients", dataProviderClass = DataProviderFactory.class)
    ...
    @Test(priority = 2,dependsOnMethods = "testAddNewClients",dataProvider = "data_Info_Clients", dataProviderClass = DataProviderFactory.class)
    ...
    @Test(priority = 3,dependsOnMethods = "testEditClients",dataProvider = "data_Info_Clients", dataProviderClass = DataProviderFactory.class)
    ...
    @Test(priority = 4,dependsOnMethods = "testDeleteClients",dataProvider = "data_Info_Clients", dataProviderClass = DataProviderFactory.class)
