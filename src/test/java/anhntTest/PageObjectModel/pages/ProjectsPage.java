...
public class ProjectsPage extends CommonPage {
    ...
    private By buttonDeleteAttachFile = By.xpath("//div[contains(@class,'list-group-item')][1]//span[normalize-space()='Delete'][1]");


    private String messageAddProjectSuccess = "Project added.";
    private String messageDeleteProjectSuccess = "Project deleted.";
    private String messageAddTaskSuccess = "Task added.";
    private String messageAddAttachFileSuccess = "Project file added.";
    ...
    public ProjectsPage verifyAddTask(Hashtable<String, String> data) {
        verifyContentMessage(messageAddTaskSuccess);
        setTextInputSearch(data.get("TITLE"));
    ...
    public ProjectsPage verifyAddAttachFile(Hashtable<String, String> data) {
        verifyContentMessage(messageAddAttachFileSuccess);
        return this;
    }
    public ProjectsPage deleteAttachFile(Hashtable<String, String> data){
        setTextInputSearch(data.get("PROJECT"));
        clickButtonViewDtails();
        clickButtonAttachFile();
        WebUI.clickElement(buttonDeleteAttachFile);
        return this;
    }
    public ProjectsPage verifyDeleteAttachFile(){
        verifyContentMessage("Project file deleted.");
        return this;
    }
